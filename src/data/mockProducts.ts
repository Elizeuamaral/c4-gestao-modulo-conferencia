...
export const INITIAL_STOCK: StockItem[] = [
  {
    ...
    address: 'SETOR-A-01',
    supplier: 'Laticinios Sul',
    invoiceNumber: 'NF-10234',
    receivedDate: getRelativeDate(-5),
    notes: 'Recebido no turno da manha',
  },
  {
    id: 'stock-2',
    productCode: '7891000120114',
  ...
  },
  {
    ...
    address: 'SETOR-B-01',
    supplier: 'Graos Brasil',
    invoiceNumber: 'NF-55671',
  ...
  },
  {
    ...
    address: 'SETOR-C-03',
    supplier: 'Acucares Unidas',
    invoiceNumber: 'NF-62145',
